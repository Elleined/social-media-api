...
public class SharedPostNotificationController {
    ...
    @GetMapping
    public List<SharedPostNotificationDTO> getAll(@PathVariable("currentUserId") int currentUserId,
        ...
        return sharedPostNotificationService.getAll(currentUser, status, pageable).stream()
