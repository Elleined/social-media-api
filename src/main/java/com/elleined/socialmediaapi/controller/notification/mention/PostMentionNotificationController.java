...
@RequestMapping("/users/{currentUserId}/post-mention-notifications")
public class PostMentionNotificationController {
    ...
    @GetMapping
    public Page<PostMentionNotificationDTO> getAll(@PathVariable("currentUserId") int currentUserId,
