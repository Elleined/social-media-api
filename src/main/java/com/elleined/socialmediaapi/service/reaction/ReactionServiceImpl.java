...
public class ReactionServiceImpl implements ReactionService {
    ...
    @Override
    public Page<Reaction> getAll(User currentUser, Post post, Pageable pageable) {
        if (post.isInactive())
    ...
    @Override
    public Page<Reaction> getAll(User currentUser, Post post, Comment comment, Pageable pageable) {
        if (postServiceRestriction.notOwned(post, comment))
    ...
    @Override
    public Page<Reaction> getAll(User currentUser, Post post, Comment comment, Reply reply, Pageable pageable) {
        if (postServiceRestriction.notOwned(post, comment))
    ...
    @Override
    public Page<Reaction> getAll(User currentUser, Story story, Pageable pageable) {
    ...
    @Override
    public Page<Reaction> getAll(User currentUser, Note note, Pageable pageable) {
