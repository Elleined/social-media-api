...
class MentionMapperTest {
    ...
    void toEntity() {
        ...
        // Calling the method
        Mention expected = mentionMapper.toEntity(new User(), new User());
        ...
        assertNotNull(expected.getMentionedUser());

        assertNotNull(expected.getPosts());

        assertNotNull(expected.getComments());

        assertNotNull(expected.getAllReplyIds());

        assertNotNull(expected.getAllNotificationIds());
    }
}